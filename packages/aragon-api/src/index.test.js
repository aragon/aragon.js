...
test('should return the registerAppMetadata observable', t => {
  ...
  // act
  registerAppMetadataFn.call(instanceStub, 'uuid1', 'QmrandomhashoceBBSBGmYiHVFQLHN8Uex6CeqExmp6Ggk', ['0xcafe'])
  // assert
  t.is(instanceStub.rpc.send.getCall(0).args[0], 'register_app_metadata')
  t.deepEqual(instanceStub.rpc.send.getCall(0).args[1], ['uuid1', 'QmrandomhashoceBBSBGmYiHVFQLHN8Uex6CeqExmp6Ggk', ['0xcafe']])
  // act and assert default 'to'
  registerAppMetadataFn.call(instanceStub, 'uuid2', 'QmrandomhashoceBBSBGmYiHVFQLHN8Uex6CeqExmp6GgK')
  t.deepEqual(instanceStub.rpc.send.getCall(1).args[1], ['uuid2', 'QmrandomhashoceBBSBGmYiHVFQLHN8Uex6CeqExmp6GgK', ['*']])
})
